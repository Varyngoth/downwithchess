...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "University of Prince Edward Island"
Config.profilename = "CAT Tool for UPEI"
Config.url = "your local eduroam® support page"
Config.email = "helpdesk@upei.ca"
...
Config.user_realm = "upei.ca"
Config.ssids = ['eduroam']
Config.del_ssids = ['UPEI_WiFi_Setup', 'panthernet', 'panthernet-open']
Config.servers = ['DNS:WinRadius1.ADDS.UPEI.CA', 'DNS:WinRadius2.ADDS.UPEI.CA', 'DNS:ise.upei.ca', 'DNS:winradius1.upei.ca', 'DNS:winradius2.upei.ca']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous985715@upei.ca"
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
